    ...
    <Disclosure as='nav' className='bg-black'>
      {({ open }) => (
        <>
          ...
          h-[38px] w-[74px] shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-slate-50 bg-repeat transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2  focus-visible:ring-white/75`}
                  >
