...
const ContactPage = () => {
  ...
  return (
    <>
      <Nav />
      <div className='relative z-10 mx-auto mt-14 flex max-w-screen-xl flex-col items-center p-4 lg:px-8'>
        <div className='info-text ease-500 m-4 max-h-full w-full rounded-3xl border-2 border-red-700 bg-gradient-to-l from-red-800 to-white p-6 shadow-lg transition-all hover:border-red-500 hover:shadow-2xl dark:from-black dark:to-red-800'>
          <h1 className='text-2xl text-black dark:text-white max-md:text-lg'>
          ...
          <ul>
            {programmingServices.map((service, key) => (
              ...
              >
                ...
                <li className='text-xl tracking-wide text-black dark:text-white max-xl:text-base max-md:text-sm'>
                  {service.service}
                </li>
              </div>
            ))}
            {musicServices.map((service, key) => (
              ...
              >
                ...
                <li className='text-xl tracking-wide text-black dark:text-white max-xl:text-base'>
                  {service.service}
                </li>
              </div>
            ))}
